...
% Titel der Arbeit
\newcommand{\myTitel}{Performance comparison between WASM and JavaScript based on code implementing computationally intensive operations on the clientside}
