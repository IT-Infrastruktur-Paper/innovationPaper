...
The content chapters are further encapsulated, each having its own "structure file" (e.g. kapitelUebersicht.tex). This file references individual chapters, each of which can have its own respective structure. Here is an overview of the structure of the document:
