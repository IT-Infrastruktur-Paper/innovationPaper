...
To specify different input operations, we will show them in the following figures, while there is the fixed test part as shown above and the \dq operation part\dq  for the different test operations, which define the input given to each, JavaScript and WebAssembly within the fixed test part.
