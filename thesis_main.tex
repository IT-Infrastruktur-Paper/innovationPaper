...
\documentclass[11.5pt,oneside,titlepage,listof=totoc,bibliography=totoc]{scrartcl}
...
\usepackage[scaled=0.9]{arial} % Behebt, zusammen mit Package courier, pixelige Überschriften. Ist, zusammen mit mathptx, dem times-Package vorzuziehen. Details: https://latex-kurs.de/fragen/schriftarten/Times_New_Roman.html
\usepackage{courier}
\usepackage{amsmath}
...
\input{skripte/chapterOverview.tex}
...
\input{chapter/anhang/erklaerung}
\end{document}
